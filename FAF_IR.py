...
#     parser.add_argument("--output_dir",        default="FAF_IR_outputs")
...
def save_summary_pages(out_dir, rows, rows_per_page=20,
    ...
    as a separate summary PNG inside FAF_IR_Homo (no subfolders):

        <out_dir>/FAF_IR_Homo/summary_page_001.png
        <out_dir>/FAF_IR_Homo/summary_page_002.png
        ...
